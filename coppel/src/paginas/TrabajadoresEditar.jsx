...
import { EditTrabajador } from '../api/apiTrabajadores';
...
export default function TrabajadoresEditar() {
  const { id } = useParams();

  const { mutate, isLoading } = useMutation(EditTrabajador, {
    onSuccess: () => {
      reset();
      console.log('Empledo actualizado con éxito');

    },
    onError: (error) => {
      alert('Error al actualizar datos del empleado.');
        ...
        <form onSubmit={onSubmit}>
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="text-xl font-semibold leading-7 text-gray-900 mb-3">Actualizar empleado</h2>
